<?php
 ...
 if ( isset($_POST['submit']) ) {
  ...
  if( !$error ) {
   ...
   $query = "INSERT INTO dairy1(date,matter,email) VALUES('$date','$pass','$email')";
	...
	<body class="right-sidebar">
		...
		<!-- Main -->
			<div id="main" class="wrapper style1">
				...
				<input type="date" placeholder="dd-mm-yy" name="date"><br>
				<input type="text" placeholder="text" name="matter"><br>
